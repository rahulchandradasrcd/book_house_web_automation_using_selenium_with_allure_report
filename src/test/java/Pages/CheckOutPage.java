...
public class CheckOutPage extends BasePage{
    ...
    public By select_city_1 = By.xpath("//li[contains(text(),'রাজশাহী')]");
    public By select_city_2 = By.xpath("//li[contains(text(),'ঢাকা')]");
    public By drop_down_area = By.xpath("//span[normalize-space()='--- Select Area ---']");
    public By select_area = By.xpath("//li[contains(text(),'সিদ্ধেশ্বরী')]");
